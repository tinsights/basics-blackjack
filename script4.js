...
var displayPlayerAndDealerHands
 = function (playerHandArray, dealerHandArray) {
...
var main = function (input) {
    ...
    // dealerHasBlackJack = true;
		...
		// ELSE no one has black jack, count hand value <- remain?
    ...
    if (input == 'hit') {
      ...
      // dealerHandTotalValue = 21;
        ...
        (playerHand,dealerHand) + "<br>Its a Tie!";
			...
			// player win
      // !IMPORTANT! Explain why else statment doesn't need **playerHandTotalValue > 21**
